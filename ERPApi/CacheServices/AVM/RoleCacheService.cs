...
using static ERPApi.Services.AVM.RoleService;
...
namespace ERPApi.CacheServices.AVM
{
    ...
    public class RoleCacheService : CacheBaseService<Role, VMISContext>
    {
        ...
        /// CreateMode Service
        /// </summary>
        public class CreateService : RoleCacheService
        {
            /// <summary>
            /// 默认的基础方法
            /// </summary>
            ...
            {
                return Role.Instance.Insert(role);
            }
            /// <summary>
            /// 默认的基础方法
            /// </summary>
            ...
            /// <returns></returns>
            public override List<Role> Create(List<Role> roleList)
            {
                roleList.ForEach(
                        role =>
                        {
                            Role.Instance.Insert(role);
                        }
                    );
                return roleList;
            }
        ...
        /// UpdateMode Service
        /// </summary>
        public class UpdateService : RoleCacheService
        {
            /// <summary>
            /// 默认的基础方法
            /// </summary>
            ...
            {
                return Role.Instance.Update(role);
            }
            /// <summary>
            /// 默认的基础方法
            /// </summary>
            /// <param name="roleList"></param>
            /// <returns></returns>
            public override List<Role> Update(List<Role> roleList)
            {
                roleList.ForEach(
                        role =>
                        {
                            Role.Instance.Update(role);
                        }
                    );
                return roleList;
            }
        ...
        /// DeleteMode Service
        /// </summary>
        public class DeleteService : RoleCacheService
        {
            /// <summary>
            /// 默认的基础方法
            /// </summary>
            /// <param name="status"></param>
            /// <returns></returns>
            public override Role Delete(Role role)
            {
                return Role.Instance.Delete(role);
            }
            /// <summary>
            /// 默认的基础方法
            /// </summary>
            /// <param name="roleList"></param>
            /// <returns></returns>
            public override List<Role> Delete(List<Role> roleList)
            {
                roleList.ForEach(
                        role =>
                        {
                            Role.Instance.Delete(role);
                        }
                    );
                return roleList;
            }
        ...
        /// ColumnsMode Service
        /// </summary>
        public class ColumnsService : RoleCacheService
        {
            /// <summary>
            /// 返回字段集
            /// I.  只含本表字段
        ...
        /// 
        /// </summary>
        public class RowService : RoleCacheService
        {
            /// <summary>
            /// 根据 id 查询
            /// </summary>
            ...
            /// <returns></returns>
            public Role First(string keyWord, ModeBase.Status status, params string[] entityAttrs)
            {
                try
                {
                    // 定义
            ...
            /// <param name="entityAttrs"></param>
            /// <returns></returns>
            public Role Last(string keyWord, ModeBase.Status status, params string[] entityAttrs)
            {
                try
                {
                    // 定义
            ...
            /// <param name="entityAttrs"></param>
            /// <returns></returns>
            public Role Next(int id, string keyWord, ModeBase.Status status, params string[] entityAttrs)
            {
                try
                {
                    // 定义
            ...
            /// <param name="entityAttrs"></param>
            /// <returns></returns>
            public Role Prev(int id, string keyWord, ModeBase.Status status, params string[] entityAttrs)
            {
                try
                {
                    // 定义
        ...
        /// 
        /// </summary>
        public class RowsService : RoleCacheService
        {
            /// <summary>
            /// 返回全表数据
            /// </summary>
            /// <param name="entityAttrs">可变参数</param>
            /// <returns></returns>
            public List<Role> All(params string[] entityAttrs)
            {
                try
                {
                    return SQLToList()
        ...
        /// 
        /// </summary>
        public class TreeService : RoleCacheService
        {
            ...
            /// <param name="entityAttrs">可变参数</param>
            /// <returns></returns>
            public List<Role> ById(int id, params string[] entityAttrs)
            {
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private decimal Sum(Func<Role, decimal> selector, List<Role> entityList, params string[] entityAttrs)
        {
            try
            {
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private int Sum(Func<Role, int> selector, List<Role> entityList, params string[] entityAttrs)
        {
            try
            {
                return entityList.Sum(selector);
        ...
        /// <returns></returns>
        private Role SQLEntityToSingle(Role entity)
        {
            if (entity == null)
                return null;
            else
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private List<Role> KeyWordToList(List<Role> list, string keyWord, params string[] entityAttrs)
        {
            try
            {
                // 截取keyWord
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private List<Role> KeyWordExtToList(List<Role> list, string keyWord, params string[] entityAttrs)
        {
            try
            {
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private List<Role> DateToList(List<Role> list, DateTime startDate, DateTime endDate, params string[] entityAttrs)
        {
            try
            {
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private List<Role> StatusToList(List<Role> list, ModeBase.Status status, params string[] entityAttrs)
        {
            try
            {
                return list;
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private List<Role> SortToList(List<Role> list, ModeBase.Sort sort, params string[] entityAttrs)
        {
            try
            {
        ...
        /// <param name="entityAttrs"></param>
        /// <returns></returns>
        private List<Role> PageToList(List<Role> list, int pageIndex, int pageSize, params string[] entityAttrs)
        {
            try
            {
                return list
        ...
        /// </summary>
        /// <returns></returns>
        private List<Role> SQLToList()
        {
            try
            {
                return Role.Instance.CacheAll();
            }
            catch (Exception ex)
            {
                throw ex;
